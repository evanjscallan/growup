...
export const DropdownOptionUI: string | FC<OptionProps> = ({
  plantUIDisplay,
  setPlantUIDisplay,
  dropdownSelection,
  ...
  const selectedPlant = (Object.values(plants) as Plant[]).find(
    (plant) => plant.plantName === dropdownSelection
  );
  ...
  return (
    <div className="plant-info-modal">
      ...
      <ul>
        ...
        <li>
          <b>Description:</b> {plantDescription}{" "}
        </li>
        <li>
          <b>Watering Frequency:</b> {plantWaterFreqDescription}{" "}
        </li>
        <li>
          <b>Sunlight Needs:</b> {plantSunlightNeeds}{" "}
        </li>
        <div>
          <img
            className="plant-image"
            src={plantImg}
            alt="image of rhodesian eggplant"
            width="300"
          />
        </div>
      </ul>
